@component($typeForm, get_defined_vars())
    <div data-controller="cropper"
         data-cropper-type-value="image/jpeg"
    ...
    >
        <div class="border-dashed text-end p-3 cropper-actions">
            ...
            <span class="mt-1 float-start">Spielfoto auswählen:</span>

            <div class="d-inline-flex flex-wrap gap-2 justify-content-end">
                <label class="btn btn-default m-0">
                    <x-orchid-icon path="bs.camera" class="me-2"/>
                    Foto aufnehmen
                    <input type="file" accept="image/*" capture="environment"
                           data-action="change->cropper#upload"
                           class="d-none">
                </label>
                <label class="btn btn-default m-0">
